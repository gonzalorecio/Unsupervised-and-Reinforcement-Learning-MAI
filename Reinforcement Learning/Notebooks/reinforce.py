...
def main():
    ...
    parser.add_argument("--save_path", type=str, default="models/", help="path for saving models")
    parser.add_argument("--expt_name", type=str, default="plots/", help="expt name for saving results")
